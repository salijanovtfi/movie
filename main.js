const API_KEY = "ab2416e745a5c8b55f577051875c4c54";
const image_path = "https://www.themoviedb.org/t/p/w300"
...
async function get_movie_by_search (search_term) {
    const resp  = await fetch(`https://api.themoviedb.org/3/search/movie?query=${search_term}&api_key=${API_KEY}`);
    ...
    <div class="content">
        ...
        <div class="right">
            ...
            <div class="single-info-container">
                ...
                <div class="single-info">
                    <span>Length:</span>
                    <span>${movie.runtime} miutes</span>
                </div>
                <div class="single-info">
                    <span>Rate:</span>
            ...
            <div class="trailer">
                <h2>Trailer</h2>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/${movie_trailer}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
    </div>
    `
...
// container that we add these movies to a card. liked movies

function get_LS() {
    const movie_ids = JSON.parse(localStorage.getItem("movie_id"))
